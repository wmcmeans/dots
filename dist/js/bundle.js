...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dotsView = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	View.prototype.renderGame = function (event) {
	  ...
	  (0, _util.queryEl)('.dots-game').addEventListener('mousedown', this.beginMove.bind(this));
	  (0, _util.queryEl)(window).addEventListener('mouseup', this.endMove.bind(this));
	  (0, _util.queryEl)('.directions-link').addEventListener('click', this.renderMenu.bind(this));
	};
	...
	View.prototype.beginMove = function (event) {
	  ...
	  (0, _util.queryEl)(event.target).addClass('active');
