	...
	View.prototype.updateSpots = function () {
	  ...
	  this.board.grid.forEach(function (column, x) {
	    column.forEach(function (spot, y) {
	      ...
	      if (this.board.alteredCols[spot.pos[0]] <= spotY) {
...
/***/ function(module, exports) {
	...
	var Board = function () {
	  this.selectedDots = [];
	  this.setup();
	  this.alteredCols = { 0: 6, 1: 6, 2: 6, 3: 6, 4: 6, 5: 6 };
	};
	...
	Board.prototype.update = function () {
	  ...
	  this.selectedDots.forEach(function (dot) {
	    ...
	    if (this.alteredCols[dotColumn] > dotRow) {
	      this.alteredCols[dotColumn] = dotRow;
	    }
