...
/***/ function(module, exports, __webpack_require__) {
	...
	View.prototype.handleDotClick = function (event) {
	  ...
	  var startDot = this.board.grid[pos[0]][pos[1]];
	...
	View.prototype.setupGrid = function () {
	  ...
	  for (var x = 0; x < 6; x++) {
	    ...
	    if (x < 5) {
	      verticalConnections += "<ul class='vertical-connections connections group'>";
	      horizontalConnections += "<ul class='horizontal-connections connections group'>";
	    }
	    for (var y = 0; y < 6; y++) {
