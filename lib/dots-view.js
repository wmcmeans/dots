...
View.prototype.handleDotClick = function (event) {
  ...
  function formConnection(firstDot, secondDot) {
    ...
    var htmlId = [
      firstDot.pos[0] + "-" + firstDot.pos[1],
      secondDot.pos[0] + "-" + secondDot.pos[1]
    ];
    $('li#' + htmlId[0] + "to" + htmlId[1]).addClass('active purple');
    $('li#' + htmlId[1] + "to" + htmlId[0]).addClass('active purple');
